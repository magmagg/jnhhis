                ...
                foreach($beds as $bed){
                  echo "<tr>";
                    ...
                    if($bed['patient_id'] == ""){
                      ...
                      echo "<td>";
                        echo "<a href='".base_url()."Nurse/ChoosePatientToDR/".$bed['bed_id']."/".$bed['bed_roomid']."' role='button' class='btn btn-info btn-xs'>ADMIT PATIENT</a>";
                      echo "</td>";
                    }else{
                      echo "<td>".$bed['first_name']." ".$bed['middle_name']." ".$bed['last_name']."</td>";
                      echo "<td>OCCUPIED</td>";
                      echo "<td>";
                        echo "<a href='".base_url()."Nurse/DischargePatient/".$bed['patient_id']."/".$bed['bed_id']."' role='button' class='btn btn-default btn-xs'>DISCHARGE</a>'";
                        echo "<a href='".base_url()."Nurse/PatientList/".$bed['patient_id']."' role='button' class='btn btn-default btn-xs'>PATIENT INFO</a>'";
